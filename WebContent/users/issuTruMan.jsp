...
<body>
	<form name="tru" method="post" action="<%=path%>/user/truUpdate">
		<h3>发布车源信息</h3>
		<table>
		    <tr>
		     	<td>编号</td>
			    <td><input type="text" name="id" value="${tru.id }"
			...
			<tr>
				...
				<td><input type="text" name="truckLong" required="required" value="${tru.truckLong }"/></td>
			</tr>
			<tr>
				<td>载&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp重：</td>
				<td><input type="text" name="truckLoad" required="required" value="${tru.truckLoad }"/></td>
			</tr>

			<tr>
				<td>联系人员：</td>
				<td><input type="text" name="linkman" required="required" value="${tru.linkman }"/></td>
			</tr>
			<tr>
				<td>联系电话：</td>
				<td><input type="text" name="phone" required="required" value="${tru.phone }"/></td>
			</tr>
			<tr>
				<td>有效日期：</td>
				<td><input type="date" name="term" required="required" value="${tru.term }"/></td>
			</tr>
			<tr>
