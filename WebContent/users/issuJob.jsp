...
<body>
	...
	<form name="job" method="post" action="<%=path%>/user/jobAdd?userId=${user.id}">
		<h3>发布招聘信息</h3>
		<table>
			<tr>
				<td>招聘职位：</td>
			...
			<tr>
				<td>要求专业：</td>
				<td><input type="text" name="specialty" required="required" /></td>
			</tr>
			<tr>
				<td>工作经验：</td>
			...
			<tr>
				...
				<td><input type="text" name="pay" required="required"/></td>
			</tr>
			<tr>
