...
<body>
	...
	<form name="dep" method="post" action="<%=path%>/user/depAdd?userId=${user.id}">
		<h3>发布仓储信息</h3>
		<table>
			<tr>
				<td>仓储类别：</td>
			...
			<tr>
				...
				<input type="hidden" name="depotCity" /></td>
			</tr>
			<tr>
				<td>仓库地点：</td>
				<td><input type="text" name="depotSite" required/></td>
			</tr>
			<tr>
				<td>面&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp积：</td>
				<td><input type="text" name="depotAcreage" required/></td>
			</tr>
			<tr>
				<td>数&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp量：</td>
				<td><input type="number" name="depotSum" required/>(只能输入数字)</td>
			</tr>
			<tr>
				<td>价&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp格：</td>
				<td><input type="text" name="depotPrice" required/>元/间</td>
			</tr>
			<tr>
				<td>配套服务：</td>
			...
			<tr>
				<td>有效日期：</td>
				<td><input type="date" name="term" required/></td>
			</tr>
			<tr>
